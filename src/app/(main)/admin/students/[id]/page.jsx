  ...
  return (
    <PageContent>
      ...
      <div className="flex items-center gap-3 mb-6">
        <button onClick={() => router.back()} className="p-2 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-white transition-colors">
    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <InfoPair label="RTE Student"     value={student.isRTE ? 'Yes' : 'No'} />
          <InfoPair label="Govt. Contribution" value={student.isRTE ? fmtMoney(student.rteFee) : '—'} />
