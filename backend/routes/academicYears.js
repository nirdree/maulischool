...
router.post('/',  authorize('admin'), protect, async (req, res) => {
  try {
...
router.put('/:id', authorize('admin'), protect, async (req, res) => {
  try {
...
router.patch('/:id/set-current', authorize('admin'), protect, async (req, res) => {
  try {
